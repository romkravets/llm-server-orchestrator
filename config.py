...
# Distinct models per role — deliberately not the same model reviewing its
# own work. Implementer needs tool-calling support; reviewer/security only
# need to read a diff and reason about it.
