"""The agent graph: worker (LLM + tools loop) -> human_review (interrupt) ->
resumes with the human's decision. Same shape as the workshop's Day 1 agent,
plus a human-approval gate before anything gets landed.
"""
...
graph_builder.add_conditional_edges(
    "worker", route_after_worker, {"tools": "tools", "human_review": "human_review"}
)
